...
A Pearson's correlation could be applied to answer the research question: How does the amount of sleep in hours influence the amount of coffee consumed in ounces per day? Here, a Pearson's correlation is appropriate because it uses parametric tests, the variables are continuous and observations are independent. Additionally, the research question asks for the strength of correlation or how strongly the predictor influences the response variable making Pearson's correlation an appropriate test.
